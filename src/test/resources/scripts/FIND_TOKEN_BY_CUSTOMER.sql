...
INSERT INTO token (id, expired, revoked, token, token_type, admin_id, user_id) VALUES (1, FALSE, FALSE, 'LSVMSLMDZCKLMCS', 'BEARER', null, 1 );
INSERT INTO token (id, expired, revoked, token, token_type, admin_id, user_id) VALUES (2, FALSE, FALSE, 'LSVMSLMDZCKLMDS', 'BEARER', null, 1 );
INSERT INTO token (id, expired, revoked, token, token_type, admin_id, user_id) VALUES (3, FALSE, FALSE, 'LSVMSLMDZCKLMES', 'BEARER', null, 2 );
